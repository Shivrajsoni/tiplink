...
//             error: "Supported tokens could not be retrieved."
//         }, { status: 500 });
//     }
...
//         usdBalance: (balances[index] * parseFloat(token.price)).toFixed(2),
//     }));

//     return NextResponse.json({
//         tokens,
//         // reducing array to single number and adding total balance and giving it 
//         totalBalance: tokens.reduce((acc: number, val) => acc + Number(val.usdBalance), 0).toFixed(2)
//     });
// }
...
import { getSupportedTokens, connection } from "../../lib/constant";
import { LAMPORTS_PER_SOL, PublicKey } from "@solana/web3.js";
